...
export function SignInForm() {
  return (
    <div className="p-8 rounded-xl shadow-md w-full mx-auto">
      <h1 className="text-center text-[30px] font-semibold mb-4 p-5">Sign up with</h1>
      ...
      <Input placeholder="Your email adress" type="text" className="mb-5 h-12" />
      ...
      <p className="text-center text-sm mt-4">Don't have an account? <a href="#" className="text-blue-500">Sign in</a></p>
    </div>
  );
}
